...
export function Toast() {
  ...
  const toastType: 'success' | 'error' | 'info' = toast.type || 'info';
  ...
  return (
    <div className="fixed bottom-6 left-1/2 -translate-x-1/2 z-50 animate-in fade-in slide-in-from-bottom-4 duration-300">
      <div className={`flex items-center gap-3 px-5 py-3.5 rounded-2xl shadow-2xl border backdrop-blur-md max-w-md ${bgStyles[toastType]}`}>
        {icons[toastType]}
