...
export function AboutClient() {
  ...
  const doctorPortrait = settings.doctorPortraitUrl || '/assets/sir/sir-portrait.jpg';
  const doctorName = settings.doctorName || 'ডাঃ মোঃ গিয়াস উদ্দিন';
  const doctorTitle = settings.doctorTitle || 'প্রতিষ্ঠাতা ও প্রধান প্রশিক্ষক, বিডি হোমিও একাডেমি';
  const doctorDegrees = settings.doctorDegrees || 'DHMS, MSS (ঢাকা বিশ্ববিদ্যালয়), PGT (Homeo)';
  const doctorExperience = settings.doctorExperience || '২০+ বছরের অভিজ্ঞ প্র্যাকটিশনার ও ট্রেইনার';
  const doctorChamberTime = settings.doctorChamberTime || 'বিকাল ৫:০০ - রাত ৯:০০ (শুক্রবার বন্ধ)';
  const morningSupport = settings.morningSupportTime || 'সকাল ৮:০০ - ৯:০০ টা';
  const doctorMessage = settings.doctorMessage || 'হোমিওপ্যাথি কোনো অনুমানভিত্তিক চিকিৎসা নয়; এটি বিজ্ঞানের সুনির্দিষ্ট নিয়মে পরিচালিত সদৃশ চিকিৎসা পদ্ধতি। প্রাতিষ্ঠানিক ডিগ্রি অর্জনের পরও বহু নবীন চিকিৎসক বাস্তব চেম্বারে রোগী এলে কনফিউশনে পড়েন। এই ঘাটতি দূর করতেই বিডি হোমিও প্রশিক্ষণ কেন্দ্র প্রতিষ্ঠা করা হয়েছে। আমরা প্রতিটি ক্লাসে অর্গানন অব মেডিসিনের এফোরিজম, মেটেরিয়া মেডিকার ড্রাগ পিকচার ও রেপার্টরির সঠিক ব্যবহারিক সমন্বয় শেখাই যাতে ছাত্ররা আত্মবিশ্বাসের সাথে একক ওষুধ প্রয়োগ করতে পারেন।';
  const helpline = settings.helplineNumber || '01811-123993';
  const slogan = settings.slogan || 'Right Homeopath, Right Homeopathy';
  const ptfImg = settings.ptfCertificateImageUrl || '/assets/gallery/certificate-ptf-1.jpg';
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
            ...
            <div className="lg:col-span-7 space-y-5 text-left">
              ...
              <p className="text-sm sm:text-base text-amber-300 font-bold leading-relaxed">
                {slogan} — বিশুদ্ধ হ্যানিম্যানিয়ান দর্শনে নিবেদিত চিকিৎসক ও শিক্ষক
              </p>

              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed max-w-2xl">
                বিগত {doctorExperience} ধরে অর্গানন অব মেডিসিনের মৌলিক নীতিমালা, মেটেরিয়া মেডিকার ড্রাগ পিকচার ও রেপার্টরির ব্যবহারিক সমন্বয়ে বাংলাদেশের ৬৪ জেলার চিকিৎসকদের আত্মবিশ্বাসী ক্লাসিক্যাল প্র্যাকটিশনার হিসেবে গড়ে তুলছেন।
              </p>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-16">
          ...
          <div className="lg:col-span-5 bg-white p-7 rounded-3xl border border-slate-200 shadow-md space-y-4">
            ...
            <div className="space-y-3 text-xs sm:text-sm text-slate-700">
              ...
              <div className="flex items-start gap-2.5">
                ...
                <span className="font-semibold text-emerald-700">{doctorTitle}</span>
              </div>
              <div className="flex items-start gap-2.5">
                <span className="font-bold text-slate-900 w-28 shrink-0">ডিগ্রি ও যোগ্যতা:</span>
                <span className="font-semibold text-slate-800">{doctorDegrees}</span>
              </div>
              <div className="flex items-start gap-2.5">
                <span className="font-bold text-slate-900 w-28 shrink-0">অভিজ্ঞতা:</span>
                <span className="font-semibold text-slate-800">{doctorExperience}</span>
              </div>
              <div className="flex items-start gap-2.5">
                <span className="font-bold text-slate-900 w-28 shrink-0">মর্নিং কেস সাপোর্ট:</span>
                <span className="font-semibold text-teal-700">সপ্তাহে ৬ দিন {morningSupport}</span>
              </div>
              <div className="flex items-start gap-2.5">
                <span className="font-bold text-slate-900 w-28 shrink-0">চেম্বার যোগাযোগের সময়:</span>
                <span className="font-semibold text-slate-800">{doctorChamberTime}</span>
              </div>
            </div>
            ...
            <div className="p-4 bg-emerald-50 rounded-2xl border border-emerald-200 text-xs text-emerald-950 space-y-1">
              ...
              <p className="font-mono font-black text-sm text-emerald-800">{helpline}</p>
            </div>
          </div>
        ...
        <div className="bg-gradient-to-r from-emerald-950 via-slate-900 to-slate-950 text-white rounded-3xl p-8 sm:p-12 shadow-2xl border border-emerald-800/40">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 text-center divide-y lg:divide-y-0 lg:divide-x divide-emerald-800/60">
            ...
            <div className="space-y-1 pt-4 lg:pt-0">
              <span className="text-3xl sm:text-4xl font-black text-teal-400 font-mono">{doctorExperience.split(' ')[0] || '২০+'}</span>
