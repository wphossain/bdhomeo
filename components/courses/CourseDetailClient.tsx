...
export function CourseDetailClient({ initialSlug }: Props) {
  const router = useRouter();
  const { courses, settings, user, submitEnrollment, signInWithGoogle, showToast } = useApp();

  const course = courses.find((c) => 
    c.slug === initialSlug || 
    (initialSlug === 'advance-clinical-repertory' && c.slug === 'advanced-clinical-repertory') ||
    (initialSlug === 'advanced-clinical-repertory' && c.slug === 'advance-clinical-repertory')
  );
