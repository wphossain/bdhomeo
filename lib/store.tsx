      ...
      try {
        ...
        if (siteData && siteData.length > 0) {
          ...
          setSettings((prev) => ({
            ...
            galleryImages: s.gallery_images || prev.galleryImages,
            videoShowcaseList: s.video_showcase_list || prev.videoShowcaseList,
            testimonials: s.testimonials || prev.testimonials,
