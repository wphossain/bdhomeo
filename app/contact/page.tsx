      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-white p-7 rounded-3xl border border-slate-200 shadow-sm space-y-3">
            ...
            <p className="font-mono text-base font-black text-emerald-700">{s.helplineNumber}</p>
          ...
          <div className="bg-white p-7 rounded-3xl border border-slate-200 shadow-sm space-y-3">
            ...
            <p className="font-mono text-base font-black text-teal-700">{s.whatsappNumber}</p>
            <a
              href={`https://wa.me/88${s.whatsappNumber.replace(/[^0-9]/g, '')}`}
              target="_blank"
          ...
          <div className="bg-white p-7 rounded-3xl border border-slate-200 shadow-sm space-y-3">
            ...
            <p className="text-xs text-slate-700 leading-relaxed">{s.chamberAddress}</p>
          </div>
